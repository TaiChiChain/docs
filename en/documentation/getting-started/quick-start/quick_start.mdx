...
After successfully connecting to the AxiomLedger, your account balance will generally be `0` AXC. At this time, you can visit the AxiomLedger testnet [faucet](https://faucet.taurus.axiomesh.io/) and enter your account address on the webpage to receive some AXCs.
